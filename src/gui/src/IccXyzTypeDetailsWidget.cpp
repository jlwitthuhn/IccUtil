...
IccXyzTypeDetailsWidget::IccXyzTypeDetailsWidget(const std::string& tag_name, const IccXyzType& value, QWidget* const parent) :
	QWidget{ parent }
{
	...
	layout->addRow("XYZ array:", table_widget);
}
